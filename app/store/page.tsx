...
import { Crown, CheckCircle2, Shield, ArrowRight, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 space-y-16">
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <p className="text-xs sm:text-sm text-amber-300 font-mono bg-amber-950/40 border border-amber-500/40 p-3 rounded-xl max-w-xl mx-auto leading-relaxed">
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <Crown className={`w-5 h-5 ${pkg.highlight ? "text-cyan-400" : "text-slate-400"}`} />
              </div>

              <h2 className="font-heading font-bold text-2xl sm:text-3xl text-white mb-2">{pkg.name}</h2>
              <div className="font-mono font-black text-3xl sm:text-4xl text-cyan-400 mb-6">{pkg.price}</div>
            ...
            <a
              ...
              className={`w-full py-4 rounded-xl font-heading font-bold text-sm tracking-wider text-center flex items-center justify-center gap-2 transition-all ${
                pkg.highlight
            ...
            >
              PURCHASE VIA TEBEX / DISCORD <ExternalLink className="w-4 h-4" />
            </a>
          </div>
        ))}
      </div>
